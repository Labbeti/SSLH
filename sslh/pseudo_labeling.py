...
from sslh.pl_modules.pseudo_labeling import (
    PseudoLabeling,
)
...
@hydra.main(config_path=osp.join("..", "conf"), config_name="pseudo_labeling")
def main_pseudo_labeling(cfg: DictConfig) -> None:
    # Initialisation
    reset_seed(cfg.seed)
    if cfg.verbose <= 0:
