...
from sslh.augments.cutmixspec import CutMixSpec
...
class SupervisedTrainerCutMixSpec(TrainerABC):
	def __init__(
		self,
		model: Module,
		activation: Callable,
		...
		"""
			...
			:param alpha: The CutMix alpha hyperparameter used for generating the lambda coefficient for mixing
