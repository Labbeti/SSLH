...
class WideResNet28Rot(WideResNet28):
	...
	"""
	def __init__(self, n_classes: int, rot_size: int, width: int = 2, n_input_channels: int = 3):
		super().__init__(width=width, n_classes=n_classes, n_input_channels=n_input_channels)
