...
from sslh.experiments import (
	FixMatch, FixMatchMixUp, FixMatchThresholdGuess, FixMatchThresholdGuessMixUp, FixMatchUnlabeledPreProcess
)
...
def main(cfg: DictConfig):
	...
	transform_train_u = FixMatchUnlabeledPreProcess(transform_weak, transform_strong)
	...
	if cfg.experiment.fullname == "FixMatch":
		experiment_module = FixMatch(
			**module_params,
		)

	elif cfg.experiment.fullname == "FixMatch+MixUp":
		experiment_module = FixMatchMixUp(
			**module_params,
			alpha=cfg.experiment.alpha,
		)

	elif cfg.experiment.fullname == "FixMatch+ThresholdGuess":
		experiment_module = FixMatchThresholdGuess(
			**module_params,
			threshold_guess=cfg.experiment.threshold_guess,
		)

	elif cfg.experiment.fullname == "FixMatch+ThresholdGuess+MixUp":
		experiment_module = FixMatchThresholdGuessMixUp(
			**module_params,
			threshold_guess=cfg.experiment.threshold_guess,
			alpha=cfg.experiment.alpha,
		)
