"""
	Main script for running a UDA training.
"""
...
def run_uda(args: Namespace, start_date: str, fold_val: Optional[int], interface: DatasetInterface) -> Dict[str, Union[float, int]]:
	# Build loaders
...
def main():
	...
	if args.cross_validation:
		cross_validation(run_uda, args, start_date, interface, TRAIN_NAME)
	else:
		run_uda(args, start_date, args.fold_val, interface)
