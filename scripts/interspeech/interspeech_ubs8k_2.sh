...
sup_params="bsize=${bsize} expt.criterion=${criterion}"
ssl_params="bsize_s=${bsize_s} bsize_u=${bsize_u} expt.criterion_s=${criterion_s} expt.criterion_u=${criterion_u}"
...
dataset_params="dataset=${dataset} dataset.val_folds=[${fold_val}] dataset.train_folds=null"
