...
# ------------------------------------------------------
# SUP10, SUP100, MM, FM fit duration estimation ?
# ------------------------------------------------------
launcher="osi"
epochs=10
seed=1234
...
added_args_lst=(
    "data=sup_ubs8k data.dm.bsize=${bsize} data.dm.ratio=0.1"
    "data=sup_ubs8k data.dm.bsize=${bsize} data.dm.ratio=1.0"
    "data=ssl_ubs8k data.dm.bsize_s=${bsize_s} data.dm.bsize_u=${bsize_u}"
    "data=ssl_ubs8k data.dm.bsize_s=${bsize_s} data.dm.bsize_u=${bsize_u}"
)
posttag_lst=(
    "bsize_${bsize}-SUP10"
    "bsize_${bsize}-SUP100"
    "bsizes_${bsize_s}_${bsize_u}"
    "bsizes_${bsize_s}_${bsize_u}"
)
...
tag="${rd}-data_${data}-pl_${pl}-epochs_${epochs}-${posttag}-val_fold_${val_fold}"

data_args="data=${data} data.dm.train_folds=null data.dm.val_folds=[${val_fold}]"
pl_args="pl=${pl}"
other_args="tag=${tag}"
