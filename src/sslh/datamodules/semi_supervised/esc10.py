...
from sslh.datasets.utils import NoLabelDataset, TransformDataset
...
class ESC10SSLDataModule(LightningDataModule):
    def __init__(
        self,
        root: str = "data",
        ...
        :param n_workers: The number of workers for dataloader. (default: 5)
    ...
    def prepare_data(self, *args, **kwargs) -> None:
        if self.download:
            _ = ESC10(self.root, folds=FOLDS, download=True)
