...
from sslh.datamodules.multilabel_split import balanced_split, get_indexes_per_class
from sslh.datamodules.samplers import SubsetCycleSampler, BalancedSampler
from sslh.datamodules.utils import guess_num_workers_su
from sslh.datasets.fsd50k import FSD50K, FSD50KSubset
...
class FSD50KSSLDataModule(LightningDataModule):
    def __init__(
        self,
        root: str = "data",
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if stage == "fit":
            ...
            if self.sampler_s_balanced:
                ...
                self.sampler_s = SubsetCycleSampler(
                    indexes_s.tolist(), n_train_samples_s
                )

            self.sampler_u = SubsetCycleSampler(indexes_u.tolist(), n_train_samples_u)
