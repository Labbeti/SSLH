...
class CustomTensorboardLogger(TensorBoardLogger):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(additional_params, Container):
            params = str(OmegaConf.to_container(additional_params, resolve=True))
        else:
    ...
    def log_hyperparams(
        self,
        params: Union[None, Dict[str, Any], Namespace] = None,
        metrics: Union[None, Dict[str, Any]] = None,
    ) -> None:
        if params is None:
            params = {}
    ...
    def save_and_close(self):
        ...
        self.metrics_merged = {
            k: convert_val(v) for k, v in self.metrics_merged.items()
        }
