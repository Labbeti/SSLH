...
from sslh.pl_modules.remixmatch.preprocess import ReMixMatchUnlabeledPreProcess
...
def main_remixmatch(cfg: DictConfig) -> None:
    ...
    elif pl_name in ("remixmatch_norot", "remixmatch_nomixup_norot"):
        self_sup_params = {}
    else:
        raise ValueError(f"Unknown pl config group {pl_name=}.")
